...
#atsai orig                                    translation.Random(self.dim, [20, 20]),
                                    translation.Random(self.dim, [20, 20]),
                                    rotation.Random(self.dim, [0.1, 0.1]),
#atsai                                    flip.Random(self.dim, [0.25, 0]),
...
# atsai orig shift and scale=0.15
        return ShiftScaleClamp(random_shift=0.10,
                               random_scale=0.10)(normalized)
